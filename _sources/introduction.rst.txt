...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/monteverdi_madrigals.git
...
* `Claudio Monteverdi – Madrigals <https://github.com/DCMLab/monteverdi_madrigals/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the 12th madrigal from the 2nd book has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/2-12.tsv')
   notes = ms3.load_tsv('notes/2-12.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/monteverdi_madrigals/issues>`__ and feel free to fork and submit pull requests.
